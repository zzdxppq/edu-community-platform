...
> 基于一期（P0）和二期（P1）版本规划范围，将功能需求拆分为 **16 个 Epic**，共 **81 个 Story**。
> 一期 Epic 1-11（57 个 Story）；二期 Epic 12-16（24 个 Story）。
...
| **二期（P1）** | | | |
| 12 | 普通用户体系 | 6 | F-RG, B-UM-03~04 |
| 13 | 个人中心模块 | 3 | F-UC |
| 14 | 知识库建设 | 6 | B-KB |
| 15 | 智能体核心功能 | 5 | F-AI, B-AI |
| 16 | 后台二期扩展 | 4 | B-CT-05, B-SS-05, S-CT-04, S-RS-01 |
...
| 功能ID 范围 | 模块 | 对应 Epic | 对应 Story |
|-------------|------|-----------|-----------|
| F-RG-01~04 | 注册登录 | Epic 12 | 12.1~12.4 |
| F-UC-01~03 | 个人中心 | Epic 13 | 13.1~13.3 |
| B-KB-01~06 | 知识库管理 | Epic 14 | 14.1~14.6 |
| F-AI-01~05 | 智能体前端 | Epic 15 | 15.1~15.5 |
| B-AI-01~04 | 智能体后台 | Epic 15 | 15.4~15.5 |
| B-UM-03~04 | 普通用户管理 | Epic 12 | 12.5~12.6 |
| B-CT-05 | 内容统计报表 | Epic 16 | 16.1 |
| B-SS-05 | 日志管理 | Epic 16 | 16.2 |
| S-CT-04 | 内容查询（学校端） | Epic 16 | 16.3 |
| S-RS-01 | 本地资源管理（学校端） | Epic 16 | 16.4 |
